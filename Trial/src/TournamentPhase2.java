...
public class TournamentPhase2 {
    ...
    public static void main(final String[] args) {
        ...
        String filename = "/home/I6256403/project/tournament2.txt";
        // String filename = "/Users/benjamingauthier/Desktop/tournament2.txt";
        ...
        try (FileWriter fw = new FileWriter(filename, true);  // true will append to file, false (or omitted) will overwrite
            ...
            AI uct02 = MCTS.createUCT(0.2) ;
            AI uct06 = MCTS.createUCT(0.6) ;
            AI uct08 = MCTS.createUCT(0.8) ;
            AI uct12 = MCTS.createUCT(1.2) ;
            AI uct16 = MCTS.createUCT(1.6) ;
            AI uct22 = MCTS.createUCT(2.2) ;
            ...
            for (int j = 1; j < NUM_TRIALS + 1; j++) {
                ...
                for (int p = 1; p <= game.players().count(); ++p) {
                    ...
                    if (ais.get(p).friendlyName().equals("UCT" + " " + 0.2) && ranking[p] == 1) {
                        numUCT = numUCT + 1;
                    ...
                    if (ais.get(p).friendlyName().equals("UCT " + 0.2)) {
 ...
 //_______________________________________________________________________________________________________
            ...
            for (int j = 1; j < NUM_TRIALS + 1; j++) {
                ...
                for (int p = 1; p <= game.players().count(); ++p) {
                    ...
                    if (ais.get(p).friendlyName().equals("UCT" + " " + 1.2) && ranking[p] == 1) {
                        numUCT2 = numUCT2 + 1;
                        // System.out.println("numUCT2 "+numUCT2);
                    }
 ...
 //___________________________________________________________________________________________
            ...
            for (int j = 1; j < NUM_TRIALS + 1; j++) {
                ...
                for (int p = 1; p <= game.players().count(); ++p) {
                    ...
                    if (ais.get(p).friendlyName().equals("UCT" + " " + 2.2) && ranking[p] == 1) {
                        numUCT2 = numUCT2 + 1;
                        // System.out.println("numUCT2 "+numUCT2);
                    }

                    if (ais.get(p).friendlyName().equals("UCT " + 1.6)) {
                        System.out.println("Agent " + context.state().playerToAgent(p) + " " + ais.get(p).friendlyName() + " " + "achieved rank: " + ranking[p]);
                        System.out.println("Mean "+ais.get(p).friendlyName()+ " = " + (double) numUCT / j);
                        if(j==NUM_TRIALS) {
                            pw.println("Mean" +ais.get(p).friendlyName()+ " = " + (double) numUCT / (double) NUM_TRIALS);
