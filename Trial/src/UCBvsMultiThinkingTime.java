...
public class UCBvsMultiThinkingTime {

    private static final int NUM_TRIALS = 100;

    private static final String GAME = "Hex.lud" ;

    private static final double ThinkingTime = 10.0 ;

    private static int maxIterations = 21410 ;

    public static void main(final String[] args) {

         String filename = "/home/I6256403/project/HexTT0910not.txt";
       // String filename = "/Users/benjamingauthier/Desktop/ThinkingTime0002.txt";
        ...
        try (FileWriter fw = new FileWriter(filename, true);  // true will append to file, false (or omitted) will overwrite
            ...
            AI uct = MCTS.createUCT(0.8);
           // AI multi00 = MCTS.createUCBmulti2(1.6, true, 0.3);
           // AI multi01 = MCTS.createUCBmulti2(1.6, true, 0.4);
           // AI multi02 = MCTS.createUCBmulti2(1.6, true, 0.5);
            AI multi00 = MCTS.createUCBMultiMaxIterration(0.8,0.9,false) ;
            AI multi01 = MCTS.createUCBMultiMaxIterration(0.8,1.0,false);
          //  AI multi02 = MCTS.createUCBMultiMaxIterration(0.8,0.8, false);

            pw.println("Num Trials : "+NUM_TRIALS);
            pw.println("Game : "+GAME);
           // pw.println("Thinking Time iterations : "+ ThinkingTime);
            pw.println("Max Iterations : "+maxIterations);
            pw.flush();
            ...
            for (int j = 1; j < NUM_TRIALS + 1; j++) {
                ...
                while (!trial.over()) {
                   ...
                   //model.startNewStep(context, ais, ThinkingTime);
                    model.startNewStep(context, ais, -1, maxIterations, -1, 0.0);
                }
