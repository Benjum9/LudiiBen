...
public class UCBvsMulti {
    ...
    public static void main(final String[] args) {
        ...
        String filename = "/home/I6256403/project/UCBvsUCBMultiPentago.txt";
        // String filename = "/Users/benjamingauthier/Desktop/UCBvsMulti.txt";
        ...
        try (FileWriter fw = new FileWriter(filename, true);  // true will append to file, false (or omitted) will overwrite
            ...
            final Game game = GameLoader.loadGameFromName("Pentago.lud");
            ...
            AI multi = MCTS.createUCBmulti2(0.6, true, 0.4) ;
            ...
            for (int j = 1; j < NUM_TRIALS + 1; j++) {
                ...
                while (!trial.over()) {
                    ...
                    model.startNewStep(context, ais, 2.0);
                }
