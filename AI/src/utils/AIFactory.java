...
public class AIFactory
{
	...
	public static AI createAI(final String string)
	{
		...
		if(string.equalsIgnoreCase("UCBT"))
			return MCTS.createUCBT() ;

		if(string.equalsIgnoreCase("UCB-Multi"))
	...
	public static AI fromJson(final JSONObject json)
	{
		...
		else if (algName.equalsIgnoreCase("UCBT")){
			return MCTS.createUCBT() ;
		}
		else if (algName.equalsIgnoreCase("UCB-Multi")){
			return MCTS.createUCBmulti() ;
		}
